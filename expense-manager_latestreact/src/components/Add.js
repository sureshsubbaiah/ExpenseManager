...
class Add extends React.Component {
  ...
  render() {
    if (this.state.messageFromServer === '') {
      return (
        <div>
          <Button variant="success" size="sm" onClick={this.openModal}><span className="glyphicon glyphicon-plus"></span></Button>
          <Modal
            ...
            <div className='button-center'>
              <br />
              <Button variant="success" size="sm" onClick={this.onClick}>Add New Expense</Button>
            </div>
          </Modal>
        </div>
      )
        ...
        <div>
          ...
          <Modal
            ...
            <div className='button-center'>
              ...
              <Link to={{ pathname: '/', search: '?month=' + this.state.month + '&year=' + this.state.year }} style={{ textDecoration: 'none' }}>
                <Button variant="success" size="sm" onClick={this.closeModal}>Close the Dialog</Button>
              </Link>
            </div>
          </Modal>
        </div>
